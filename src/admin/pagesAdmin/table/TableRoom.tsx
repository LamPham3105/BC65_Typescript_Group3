    ...
    <div className="container">
      ...
      >
        <Form layout="vertical" initialValues={currentRoom}>
          ...
          <Form.Item name="bep" valuePropName="checked" label="Kitchen">
            <Checkbox
          ...
          <Form.Item name="doXe" valuePropName="checked" label="Parking">
            <Checkbox
          ...
          <Form.Item name="hoBoi" valuePropName="checked" label="Swimming Pool">
            <Checkbox
          ...
          <Form.Item name="banUi" valuePropName="checked" label="Ironing Board">
            <Checkbox
