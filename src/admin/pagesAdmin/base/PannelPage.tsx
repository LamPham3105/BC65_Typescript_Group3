        ...
        <div className="row">
                ...
                <div className="tab-content mt-2 mb-3" id="pills-tabContent">
                  ...
                  >
                    <p>
                      ...
                      continued her way. On her way she met a copy. The copy
                      warned the Little Blind Text, that where it came from it
                      would have been rewritten a thousand times and everything
                      that was left from its origin would be the word "and" and
                      the Little Blind Text should turn around and return to its
                      own, safe country.
                    </p>
                    <p>
                      {" "}
            ...
            <div className="card">
              <div className="card-header">
                <h4 className="card-title">
                  Nav Pills Without Border (Horizontal Tabs)
                </h4>
              </div>
              <div className="card-body">
                <ul
                  className="nav nav-pills nav-secondary nav-pills-no-bd"
          ...
          <div className="col-md-6">
            <div className="card">
              <div className="card-header">
                <h4 className="card-title">
                  Nav Pills Without Border (Vertical Tabs)
                </h4>
              </div>
              <div className="card-body">
                <div className="row">
                  <div className="col-5 col-md-4">
                    <div
                      className="nav flex-column nav-pills nav-secondary nav-pills-no-bd"
                      id="v-pills-tab-without-border"
                      role="tablist"
                      aria-orientation="vertical"
                    >
                      <a
                        className="nav-link active"
                        id="v-pills-home-tab-nobd"
                        data-bs-toggle="pill"
                        href="#v-pills-home-nobd"
                        role="tab"
                      ...
                      <a
                        className="nav-link"
                        id="v-pills-profile-tab-nobd"
                        data-bs-toggle="pill"
                        href="#v-pills-profile-nobd"
                        role="tab"
                        aria-controls="v-pills-profile-nobd"
                        aria-selected="false"
                      >
                        Profile
                      </a>
                      <a
                        className="nav-link"
                        id="v-pills-messages-tab-nobd"
                        data-bs-toggle="pill"
                        href="#v-pills-messages-nobd"
                        role="tab"
                        aria-controls="v-pills-messages-nobd"
                        aria-selected="false"
                      >
                        Messages
                      </a>
                  ...
                  <div className="col-7 col-md-8">
                    <div
                      ...
                      id="v-pills-without-border-tabContent"
                    >
                      <div
                        className="tab-pane fade show active"
                        id="v-pills-home-nobd"
                        role="tabpanel"
          ...
          <div className="col-md-6">
            <div className="card">
              <div className="card-header">
                <h4 className="card-title">
                  Nav Pills With Icon (Horizontal Tabs)
                </h4>
              </div>
              <div className="card-body">
                <ul
                  className="nav nav-pills nav-secondary  nav-pills-no-bd nav-pills-icons justify-content-center"
          ...
          <div className="col-md-6">
            <div className="card">
              <div className="card-header">
                <h4 className="card-title">
                  Nav Pills With Icon (Vertical Tabs)
                </h4>
              </div>
              <div className="card-body">
                <div className="row">
                  <div className="col-5 col-md-4">
                    ...
                    >
                      <a
                        ...
                        data-bs-toggle="pill"
                        href="#v-pills-home-icons"
                        role="tab"
                        aria-controls="v-pills-home-icons"
                        aria-selected="true"
                      >
                        <i className="icon-home" />
                        Home
                  ...
                  <div className="col-7 col-md-8">
                    <div
                      className="tab-content"
                      id="v-pills-with-icon-tabContent"
                    >
                      <div
                        className="tab-pane fade show active"
                        id="v-pills-home-icons"
                        role="tabpanel"
